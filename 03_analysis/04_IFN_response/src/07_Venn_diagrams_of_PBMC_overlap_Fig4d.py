...
diff_res = pd.read_csv(project_dir + '/03_analysis/04_IFN_response/results/pbmc_stimulated_diff_genes.csv')
...
plt.savefig(project_dir + '/03_analysis/04_IFN_response/figures/07-01_overlap_pred_but_not_diff_genes_PBMCs.pdf')
plt.clf()