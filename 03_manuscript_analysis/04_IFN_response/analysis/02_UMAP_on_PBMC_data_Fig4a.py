...
expr = np.load(project_dir + '/datasets/VEGA_PBMC/data/vega_pbmc_GO_trimmed_expr.npy')
annot = pd.read_csv(project_dir + '/datasets/VEGA_PBMC/data/vega_pbmc_annot.csv')
...
plt.tight_layout()
plt.savefig(project_dir + '/03_manuscript_analysis/04_IFN_signaling/figures/01_PBMC_UMAP.pdf')
plt.close()
