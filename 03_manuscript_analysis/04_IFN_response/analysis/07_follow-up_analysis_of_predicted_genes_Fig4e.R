...
res <- read.csv(paste0(project_dir, '/03_manuscript_analysis/04_IFN_response/results/PBMC_OVAE-119_IFN_signaling_Wilcoxon_results.csv'))
predict_genes <- res$gene[1:778]

diff_genes <- read.table(paste0(project_dir, '/03_manuscript_analysis/04_IFN_response/results/CD4T_IFN-ß_stim_up.txt'))
...
# save the dotplot
ggsave(paste0(project_dir, '/03_manuscript_analysis/04_IFN_response/figures/07-01_Enrichment_of_IFN_related_genesets.pdf'), p, width=11, height=5)
